    ...
    <>
      ...
      {selectedMbti ? (
        ...
        >
          ...
          >
            <div className="mx-auto mb-5 h-1.5 w-12 rounded-full bg-[var(--background-strong)]" />
            ...
            <article className="mt-4 rounded-[24px] border border-transparent bg-[var(--background-strong)] p-[17px]">
              <div className="overflow-hidden rounded-[16px] bg-[var(--primary-soft)]">
                <img
              ...
              <p className="mt-6 min-h-[64px] text-[12px] leading-4 text-[#64748b]">
                {selectedMbti.summary}
              </p>
            </article>
            ...
            <div className="mt-8">
              ...
              <p className="mt-4 text-center text-[12px] leading-4 text-[rgba(100,116,139,0.9)]">
                선택한 MBTI는 분석 결과에 따라 추후 변경될 수 있습니다.
              </p>
            </div>
          </div>
        </div>
